...
public class Herramientas {
	/**
	 * Transforma un angulo de grados a radianes.
	 * @param grados El angulo a transformar, medido en grados.
	 * @return El valor del angulo medido en radianes.
	 */
	...
	/**
	 * Transforma un angulo de radianes a grados
	 * @param radianes El angulo medido en radianes
	 * @return El angulo medido en grados
	 */
	...
	/**
	 * Ejecuta el sonido almacenado en el archivo pasado como parametro.
	...
	/**
	 * Ejecuta en un ciclo el sonido almacenado en el archivo pasado como parametro.
	 * @param file El archivo que contiene el sonido a ejecutar
	 */
	...
	/**
	 * Devuelve un objeto de tipo Clip que contiene el sonido (o musica) cargado 
	 * desde el archivo pasado como parametro.
	 * 
	 * Para ejecutar una vez el un Clip se puede utilizar la funcion start() de 
	 * este objeto. Por otro lado, para ejecutar el sonido en forma ciclica se
	 * puede utilizar la funcion loop() de este objeto. La cual toma como 
