...
public class Entorno extends JFrame
{
     ...
     */
	public Entorno(InterfaceJuego juego, String titulo, int ancho, int alto,boolean b){
		this.juego = juego;		
...
//		this.setLayout(new BorderLayout());		
	...
	/**
	 * Inicia el entorno. A partir de este llamado, se ejecutara la funcion
	 ...
	 * @param angulo El angulo de rotacion para la imagen (promedido en radianes!)
	 */
	...
	/**
	 * Dibuja una imagen en la pantalla en las coordenadas especificadas 
	 * y la rota en el angulo especificado. Se puede especificar en que 
	 * coordenadas (relativas a la imagen) se desea que este el centro de 
	...
	/**
	 * Dibuja un rectangulo con el ancho y el alto especificados, rotado segun el angulo dado 
	 ...
	 * @param angulo El angulo de rotacion (�medido en radianes!)
	...
	/**
	 * Dibuja un triangulo en las coordenadas especificadas y rotado segun el angulo dado.
	 * @param x La coordenada x
	 * @param y La coordenada y
	...
	{
		// Dibujo el triangulo con un poligono
